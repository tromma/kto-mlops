...
issuer = "https://dev-kdqvxd5ib5d08xiq.us.auth0.com/"# This is a value from an environment variable. It allows us to not hard code some information
print(issuer)
audience = "https://agachemathis-cats-dogs.com" # this line is new
